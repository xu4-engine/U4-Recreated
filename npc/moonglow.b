[
  ...
  topics: [
    ...
    ask {Dost thou strive^/to be honest?} [
  ...
  name: "Patric the Humble Shepherd"	; 5
  pronoun: "He"
  ...
  topics: [
    ...
    ask-humility {Art thou^/totally humble?} [
      {Doubtful!}
      {Strive to be.}
    ]
  ]
  ...
  topics: [
    ...
    ask {Dost thou know^/how to best mix^/spells?} [
      {Good!}
  ...
  topics: [
    ...
    "FORT" {Give thy palm.}
    ask {Dost thou wish^/thy destiny?} [
  ...
  topics: [
    ...
    ask {Dost thou seek^/an inn or^/healing?} [
      {Which?}
