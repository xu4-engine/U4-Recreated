[
  ...
  topics: [
    ...
    ask {Hast thou such^/a vessel?} [
      {Ask Blissful of^/the abyss.}
      {Ask Blissful of^/the abyss.}
    ]
  ]
][
  ...
  topics: [
    ...
    ask {Art thou well?} [
      {Very good.}
      {Visit our^/healers, I am^/sure they can^/help thee!}
    ]
  ...
  topics: [
    ...
    ask {Hast thou^/seen him?} [
      {Ask him!}
      {Stay at the inn^/until he shows^/himself!}
    ]
  ]
][
  name: "Mentorian"	; 3
  ...
  topics: [
    "job" {I use magic.}
    ask {Dost thou^/study magic?} [
      {Best of luck^/with thy^/studies!}
      {Too bad.}
    ]
    "health" {Fine.}
  ...
  name: "Rabindranath tagore"	; 10
  pronoun: "He"
  look: "a wise man."
  topics: [
    "job" {I speak of love.}
    ask {Dost thou seek^/to carry love in^/thy heart?} [
  ...
  topics: [
    ...
    ask {Know ye what^/they are?} [
      {Good.}
      {The truths of^/the universe,^/the love of the^/heart, and the^/courage of the^/soul!}
    ]
  ]
][
  name: "Circe"	; 15
