[
  ...
  topics: [
    ...
    "health" {Overworked!}
    "LADY" {I serve Marcy.}
    ask {Art thou allowed^/to be in here?} [
  ...
  topics: [
    ...
    ask {Hast thou solved^/the altars?} [
      {Good.}
  ...
  topics: [
    ...
    ask {Art thou here in^/search of love?} [
  ...
  topics: [
    ...
    "LOVE" {Ask the others.}
    ask-humility {Art thou the^/most loving^/person?} [
      {Doubtful!}
      {Strive for love!}
    ]
  ]
  ...
  topics: [
    ...
    ask {Will you give me^/some money?} [
  ...
  topics: [
    ...
    ask {Dost thou^/know where^/to find it?} [
      {Very good.}
